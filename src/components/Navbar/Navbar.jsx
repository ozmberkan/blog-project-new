  ...
  return (
    <div className="py-4 px-80 bg-[#0F0F10] transition-all duration-500 dark:bg-[#fff] dark:border-zinc-300 flex items-center justify-between border-b border-zinc-700 w-full ">
      ...
      <div className="flex  items-center gap-x-2.5 ">
        ...
        <div className="py-3 hover:bg-zinc-800 px-5 cursor-pointer text-[#d4d2d2] dark:text-[#141414] dark:bg-[#f1f1f1]  group transition-all duration-500 bg-zinc-900 rounded-md  flex">
          <div className="flex items-center justify-center gap-x-2">
